...
(
    ...
    `order_total_amount`     decimal(32, 8) COMMENT '订单总价格',
    ...
    `order_freight`          decimal(32, 8) NULL DEFAULT 0 COMMENT '订单运费;默认可以为零，代表包邮',
    `order_delete_status`    INT            NULL DEFAULT 0 COMMENT '逻辑删除状态;1: 删除 0:未删除',
    `order_create_time`      datetime       NULL COMMENT '创建时间（成交时间）',
    `order_update_time`      datetime       NULL COMMENT '更新时间',
